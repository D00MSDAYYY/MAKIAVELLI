...
void Server_GUI::redraw()
{
    ...
    ui->bots_num_label->setText(QString::number(_game_server->botNum().first) + "/" + QString::number(_game_server->botNum().second));
    ui->rounds_num_label->setText(QString::number(_game_server->roundsNum().first) + "/" + QString::number(_game_server->roundsNum().second));
    ui->thinking_t_num_label->setText(QString::number(_game_server->thinkingTime()) + "s");
}
